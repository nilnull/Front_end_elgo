		...
		<div class="row">
			...
			<div class="card__full">
				<div class="card-container row">
					<div class="float-left">
						<h5 class="h5 bold">Share!</h5>
						<span class="block h6">Create a post to be shared by users on their social platforms.</span>
					</div>
					<div class="float-right">
						<ul class="no-margin no-padding no-style">
							<li class="step__item"><p class="bold">Step 1</p>Choose<br>Campaign</li>
							<li class="step__item"><p class="bold">Step 2</p>Edit<br>Campaign</li>
							<li class="step__item step__item--active"><p class="bold">Step 3</p>Invite<br>Users</li>
			...
			<form>
				...
				<div class="createCampain__form-container">
					...
					<p class="h6 bold text-center">Choose a group to invite</p>
					
					
					<ul class="text-center">
					
						<li class="inline">
							<div class="groupToInvite__group-item table circle bg-color--orange">
								<div class="table-cell">
									<span class="block light h4">1,300</span>
									<span class="block light h7">users</span>
									<a href="#" class="text-color--white"><i class="fa fa-pencil"></i></a>
								</div>
							</div>
							Pro Social Media
						</li>
						...
						<li class="inline">
							<div class="groupToInvite__group-item table circle bg-color--red">
								<div class="table-cell">
									<span class="block light h4">5</span>
									<span class="block light h7">users</span>
									<a href="#" class="text-color--white"><i class="fa fa-pencil"></i></a>
								</div>
							</div>
						...
						<li class="inline">
							<div class="groupToInvite__group-item table circle bg-color--slateblue">
								<div class="table-cell">
									<span class="block light h4">49</span>
									<span class="block light h7">users</span>
									<a href="#" class="text-color--white"><i class="fa fa-pencil"></i></a>
								</div>
							</div>
						...
						<li class="inline">
							<div class="groupToInvite__group-item table circle bg-color--pinegreen">
								<div class="table-cell">
									<span class="block light h4">2</span>
									<span class="block light h7">users</span>
									<a href="#" class="text-color--white"><i class="fa fa-pencil"></i></a>
								</div>
							</div>
						...
						<li class="inline">
							<div class="groupToInvite__group-item table circle bg-color--bondieblue">
								<div class="table-cell">
									<span class="block light h4">541</span>
									<span class="block light h7">users</span>
									<a href="#" class="text-color--white"><i class="fa fa-pencil"></i></a>
								</div>
							</div>
						...
						<li class="inline">
							<div class="groupToInvite__group-item groupToInvite__group-item__newGroup table circle">
								<div class="table-cell">
									<a href="#" class="text-color--white"><i class="fa fa-plus"></i></a>
								</div>
							</div>
							New Group
						</li>
